      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Join thousands of successful entrepreneurs building their beauty
            business empire
          </p>
        </div>
          ...
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="relative mb-6">
                <div
                  className={`inline-flex p-4 bg-gradient-to-br ${stat.color} rounded-2xl shadow-lg group-hover:scale-110 transition-transform duration-300`}
                >
              ...
              <div className="mb-2">
                <span
                  className={`text-4xl lg:text-5xl font-bold bg-gradient-to-br ${stat.color} bg-clip-text text-transparent`}
                >
                  {stat.value}
                </span>
                <span
                ...
                {[...Array(3)].map((_, i) => (
                  <div
                    ...
                    className={`absolute w-2 h-2 bg-gradient-to-br ${
                      stat.color
                    } rounded-full opacity-20 animate-float-${i + 1}`}
                    style={{
                      top: `${20 + i * 30}%`,
                      left: `${10 + i * 20}%`,
        ...
        <div className="text-center mt-16 animate-fade-in-delay">
          <div className="bg-white/20 backdrop-blur-lg rounded-3xl border border-white/30 p-8 max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Start your journey today and become part of our thriving network
